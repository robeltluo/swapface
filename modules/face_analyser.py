...
def write_detect_face(input_face:str, target_face:str) -> None:
    input_image = cv2.imread(input_face)
    faces = get_face_analyser().get(input_image)
    ...
    # 保存标记后的图像
    cv2.imwrite(target_face, input_image)
